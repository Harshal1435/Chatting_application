    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 py-8 transition-colors duration-200">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Join and start chatting today</p>
        </div>
        ...
        >
          ...
          <div className="mb-4">
            ...
            {errors.fullname && (
              <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.fullname.message}</p>
            )}
          </div>
